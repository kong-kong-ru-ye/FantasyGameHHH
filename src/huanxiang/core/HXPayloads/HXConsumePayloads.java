package huanxiang.core.HXPayloads;
...
public class HXConsumePayloads extends Consume {
    public PayloadStack[] payloads;

    public HXConsumePayloads(PayloadStack[] items) {
    }

    public void HXConsumePayloads(PayloadStack[] payloads) {
