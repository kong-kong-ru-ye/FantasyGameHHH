...
public class HXPlanets {
    ...
    public static void load() {
        ...
        ZXCVZXVCZV = new HXPlanet("erexcvbxzsdvfgzsxdv xzcvxzcvzxcv cvxcvkir", null, 1f, 2){{
        ...
        ACASFCDAS = new Planet("tantBNCVBVBCros", ZXCVZXVCZV, 1f, 2) {{
        ...
        erekir = new Planet("erexcvbxcvxcvkir", Planets.sun, 1f, 2){{
            generator = new ErekirPlanetGenerator();
            meshLoader = () -> new HexMesh(this, 5);
            cloudMeshLoader = () -> new MultiMesh(
                    new HexSkyMesh(this, 2, 0.15f, 0.14f, 5, Color.valueOf("eba768").a(0.75f), 2, 0.42f, 1f, 0.43f),
